        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="container-fluid">
				<div class="navbar-header">
					...
					{else}
					<ul class="nav navbar-nav navbar-top-links">
						<li><a href="{$smarty.server.SCRIPT_NAME}">Home</a></li>
						<li><a href="http://grlc.life">GRLC.Life</a></li>
						<li><a href="http://garlicinsight.com">GarlicInsight</a></li>
					</ul>	
					{/if}
				</div>
				...
				<!--<li class="well well-sm" style="padding:5px; margin:0;">
				 ...
				 <li class="" style="padding:5px; margin:0;">
					<a href="{$smarty.server.SCRIPT_NAME}?page=statistics&action=pool"><b id="navWorkers">{$GLOBAL.workers}</b> <small>workers</small> | <b id="navHash">{$GLOBAL.hashrate|round:1}</b> <small>{$GLOBAL.hashunits.pool}</small></a>
				 </li>
