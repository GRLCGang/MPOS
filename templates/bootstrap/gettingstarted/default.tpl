 <div class="row">
    ...
    <h4>3. <strong>Configure your miner</strong></h4>
	  ...
	  <pre>ccminer-x64.exe --algo=allium -i 20 -o stratum+tcp://{$SITESTRATUMURL|default:$smarty.server.SERVER_NAME}:{$SITESTRATUMPORT|default:"3333"} -u <em>username</em>.<em>WorkerName</em> -p <em>WorkerPassword</em> --max-temp=85</pre>
